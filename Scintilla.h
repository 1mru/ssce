...
be distributed.
 * Note: License.txt has been renamed to THIRD_PARTY_LICENSES.txt and moved to
the top level directory.
 * /

/* Most of this file is automatically generated from the Scintilla.iface
interface definition
 * file which contains any comments about the definitions. HFacer.py does the
generation. */
...
typedef sptr_t (*SciFnDirect)(sptr_t ptr, unsigned int iMessage, uptr_t wParam,
                              sptr_t lParam);
typedef sptr_t (*SciFnDirectStatus)(sptr_t ptr, unsigned int iMessage,
                                    uptr_t wParam, sptr_t lParam, int* pStatus);

#ifndef SCI_DISABLE_AUTOGENERATED

/* ++Autogenerated -- start of section automatically generated from
 * Scintilla.iface */
...
struct SCNotification {
  ...
  Sci_Position
      annotationLinesAdded; /* SCN_MODIFIED with SC_MOD_CHANGEANNOTATION */
